...
(function () {
  ...
  const GAMES = [
    ...
    { id: "wordle", name: "Word Guess", url: "https://tileworksgamesstudio.github.io/86Wordle/", enabled: true, icon: "rows" },
    { id: "extra", name: "Extra", url: "https://tileworksgamesstudio.github.io/86Wordsearch/", enabled: true, icon: "plus" }
  ];
